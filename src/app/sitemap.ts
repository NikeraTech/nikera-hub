...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/mortgage-adviser-languages`, lastModified: "2026-07-31", changeFrequency: "weekly", priority: 0.82 },
    { url: `${baseUrl}/self-employed-mortgages`, lastModified: "2026-07-31", changeFrequency: "weekly", priority: 0.82 },
    { url: `${baseUrl}/visa-mortgages`, lastModified: "2026-07-31", changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/family-deposit-support`, lastModified: "2026-07-31", changeFrequency: "weekly", priority: 0.8 },
